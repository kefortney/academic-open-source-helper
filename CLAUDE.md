# Academic Open-Source Helper — Claude Context

This plugin provides five skills for helping academic researchers take a repository from closed to fully open source.
...
**Issues-first, researcher-as-author.** This plugin never silently makes changes to the scholarly record. CRITICAL findings (secrets, dead DOIs) produce blocking reports with exact remediation steps. Generated files are always clearly marked as drafts requiring human review and approval before committing.
